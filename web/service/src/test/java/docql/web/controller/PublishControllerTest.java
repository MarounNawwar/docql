...
class PublishControllerTest {
    ...
    void publish_mapsRequestAndReturnsDto() {
        var requestDto = new PublishRequestDto("eng", "docs", "1.0.0", List.of(), "index.md", List.of());
        var domainRequest = new docql.core.PublishRequest("eng", "docs", "1.0.0", List.of(), List.of(), "index.md");
